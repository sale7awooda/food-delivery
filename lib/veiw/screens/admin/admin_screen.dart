            ...
            body: Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                  ...
                  title: Column(children: [
                    ConstrainedBox(
                        ...
                        child: ClipRRect(
                            ...
                            child: Image.asset('images/backpic.jpg'))),
                    const Divider(indent: 8.0, endIndent: 8.0)
                  ]),
                  footer: const Padding(
                      padding: EdgeInsets.all(8.0),
                      child: Text('Food Delivery System',
              ...
              Expanded(
                  child: PageView(
                    ...
                    Container(color: Colors.white, child: const ManageOrders()),
                    Container(color: Colors.white, child: const ManageFoods())
                  ]))
            ])));
  }
}
