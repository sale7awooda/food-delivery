        ...
        body: Column(
          children:  [
           ...
           const SizedBox(height: 20),
            Expanded(
                  child: StreamBuilder(
                      stream: fstoreCtrl.foodCol.where(ffoodCategID, isEqualTo: fCategoryID).snapshots(),
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          child: ResurantWdgt(
                                            title: streamSnapshot.data!.docs[index][ffoodName],
                                            subtitle:
                                                streamSnapshot.data!.docs[index][ffoodDetails],
                                            imgUrl: streamSnapshot.data!.docs[index][ffoodImgURL],
                                          ),
                                        ));
                                  });
                        }
